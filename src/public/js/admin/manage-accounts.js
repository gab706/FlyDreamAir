(async () => {
    ...
    const users = await ClientStorageSolutions.fetchUsers('userID', () => true);
        ...
        pageUsers.forEach(user => {
            ...
            $userTable.append(`
                <tr>
                    ...
                    <td><img src="${escapeHTML(user.profile_pic)}" alt="${escapeHTML(user.name)} Avatar" class="avatar-small"></td>
                    ...
                    <td>
                        <div class="table-actions">
                            <i class="fas fa-eye action-impersonate" data-user-id="${escapeHTML(user.userID)}" title="Impersonate"></i>
                            <i class="fas fa-edit action-edit" data-user-id="${escapeHTML(user.userID)}" title="Edit"></i>
                            <i class="fas fa-trash action-delete" data-user-id="${escapeHTML(user.userID)}" title="Delete"></i>
                        </div>
                    </td>
                </tr>
            `);
