$(document).ready(function () {
    ...
    (async () => {
        ...
        for (const user of users)
            await ClientStorageSolutions.createUser({ ...user });
        ...
        for (const flight of flights)
            await ClientStorageSolutions.createFlight(flight);
        ...
        for (const booking of bookings)
            await ClientStorageSolutions.createBooking(booking);
        ...
        for (const reward of rewards)
            await ClientStorageSolutions.createReward(reward);
